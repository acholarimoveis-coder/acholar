...
function parseZap(listings) {
  ...
  for (const L of listings) {
    ...
    if (venda) { tipo_negocio = "venda"; preco = venda; }
      ...
      // Sem preço ("sob consulta"): ainda importa, como "Consulte".
      // Descobre venda/locação pelo tipo de transação; na dúvida, venda.
      const tt = String(L.TransactionType || d.BusinessType || "").toLowerCase();
      tipo_negocio = (tt.includes("rent") || tt.includes("loca") || tt.includes("alug")) ? "locacao" : "venda";
      preco = null;
    }
